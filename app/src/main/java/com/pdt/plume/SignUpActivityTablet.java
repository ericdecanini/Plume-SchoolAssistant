...
public class SignUpActivityTablet extends AppCompatActivity {

    String LOG_TAG = SignUpActivityTablet.class.getSimpleName();
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (password.isEmpty() || email.isEmpty() || nickname.isEmpty()) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(SignUpActivityTablet.this);
                    ...
                    if (confirmPasswordEditText.length() == 0) {
                        ...
                        mFirebaseAuth.createUserWithEmailAndPassword(email, password)
                                .addOnCompleteListener(SignUpActivityTablet.this, new OnCompleteListener<AuthResult>() {
                                    @Override
                                    public void onComplete(@NonNull com.google.android.gms.tasks.Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(SignUpActivityTablet.this);
                                            preferences.edit()
                                            ...
                                            Intent intent = new Intent(SignUpActivityTablet.this, MainActivity.class);
