...
public class PeerProfileActivityTablet extends AppCompatActivity {

    String LOG_TAG = PeerProfileActivityTablet.class.getSimpleName();
                ...
                builder.setMessage(getString(R.string.dialog_remove_peer, profileName))
                        ...
                        .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent intent = new Intent(PeerProfileActivityTablet.this, PeopleActivityTablet.class);
    ...
    private void getPeerClassesArrayData() {
        ...
        classesRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                Schedule schedule = new Schedule(PeerProfileActivityTablet.this, iconUri, title,
                        "", "", "", "", "");
