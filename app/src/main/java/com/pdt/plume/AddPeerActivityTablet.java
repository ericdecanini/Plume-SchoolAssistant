...
public class AddPeerActivityTablet extends AppCompatActivity {
        ...
        FirebaseDatabase.getInstance().getReference()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(AddPeerActivityTablet.this, getString(R.string.requestSent, name), Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(AddPeerActivityTablet.this, MainActivity.class);
                        startActivity(intent);
                    }
        ...
        classesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot classSnapshot: dataSnapshot.getChildren()) {
                    ...
                    mScheduleList.add(new Schedule(AddPeerActivityTablet.this, icon, title, teacher, room, "", "", ""));
